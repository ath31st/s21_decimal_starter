...
class ConverterTest {
  ...
  @ParameterizedTest
  @ValueSource(strings = {
      "s21_decimal dec_res = {{0xffffffff, 0xffffffff, 0x20000}};",
      "s21_decimal dec_res = {{}};",
      "s21_decimal dec_res = {{0xzz, 0x0, 0x0, 0x0}};",
      "s21_decimal dec_res = {{0xffffffff, 0xffffffff, 0xffffffff}};"
  })
  void testFromS21DecToDecThrowException(String strVal) {
